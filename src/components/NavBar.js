...
//             <li className="font-black text-4xl m-4 p-2 logo text-white">GoFidget</li>
//             <div className="flex flex-row-reverse text-white">
//                 <li className="m-4 p-2"><Link to="/leadStatus/all">Lead Status</Link></li>
//                 <li className="m-4 p-2"><Link to="/">Add a New Lead</Link></li>
//             </div>
//             </ul>
//         </nav>
//     )
  ...
  <div class="relative flex items-center justify-between h-16">
    ...
    <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
      <div class="flex-shrink-0 flex items-center">
        <img class="block lg:hidden h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-indigo-500.svg" alt="GoFidget"></img>
        <Link to="/" className="font-black text-xl logo text-white">GoFidget</Link>
      </div>
      <div class="hidden sm:block sm:ml-6">
        <div class="flex space-x-4">
          <Link to="/"><a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Dashboard</a></Link>
